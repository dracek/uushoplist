...
describe(`UuShoplist.Bricks.ShopList.ShopListDetailDataProvider`, () => {
  // it("onLoad", async () => {
  //   let onLoad = jest.fn(async () => ({ content: "Hello, world!" }));
  //   let loadDtoIn = { foo: "bar" };
  //   let wrapper = mount(<UuShoplist.Bricks.ShopList.ShopListDetailDataProvider onLoad={onLoad} loadDtoIn={loadDtoIn} />);
